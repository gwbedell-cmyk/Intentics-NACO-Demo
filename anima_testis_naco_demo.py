...
st.caption("ANIMA TESTIS • Real MGE+ Ξ Geometry • The Quadratic • NACO 2026")    st.caption("Live testimony → Real MGE+ ξ_m geometry + basin analysis")
