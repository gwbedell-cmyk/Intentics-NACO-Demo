...
class MGEPlusBridge:
    ...
    gap_map = {
        0: ("The founder carries stronger relational trust than the investor is ready to extend.",
            "The investor carries stronger trust expectations than the founder has yet demonstrated."),
        1: ("The founder prioritizes broader impact more than the investor currently values.",
            "The investor expects stronger ethical framing than the founder has expressed."),
        2: ("The founder's thinking model is more developed than the investor's current framework.",
